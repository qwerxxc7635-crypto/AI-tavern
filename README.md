...
项目准备里程碑 M0 和领域模型里程碑 M1 已完成。pnpm workspace 已识别 Windows、iOS 和八个共享 package，Cargo workspace 已识别 `ember-native-bridge`；严格 TypeScript、ESLint、Prettier、Vitest、Rust fmt/Clippy 和基础 CI 已建立。共享协议及D20、关系、时钟规则已实现；SQLite迁移及Campaign、世界、角色、酒馆和NPC持久化已完成。任务/冒险等Repository和应用功能仍未实现。
