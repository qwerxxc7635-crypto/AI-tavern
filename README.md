...
项目准备里程碑 M0、领域模型里程碑 M1、持久化里程碑 M2 和AI基础设施里程碑 M3 已完成。应用层已支持使用Fake Provider创建世界、完成车卡、初始化酒馆、进行可恢复NPC对话、管理单主任务、启动隐藏冒险骨架，并完成无检定或本地D20检定的冒险回合；真实Provider、冒险结算及后续产品用例/页面仍未实现。
