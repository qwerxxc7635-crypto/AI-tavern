...
项目准备里程碑 M0 已完成。pnpm workspace 已识别 Windows、iOS 和八个共享 package，Cargo workspace 已识别 `ember-native-bridge`；严格 TypeScript、ESLint、Prettier、Vitest、Rust fmt/Clippy 和基础 CI 已建立。当前已完成主要共享协议、可注入随机源的 D20 规则引擎，以及关系与世界时钟规则；事件、数据库和应用功能仍未实现。
